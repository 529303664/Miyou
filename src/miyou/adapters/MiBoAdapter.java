...
import utilclass.RoundedImageView;
...
public class MiBoAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			viewHolder.mRoundedImageView = (RoundedImageView)convertView.findViewById(R.id.tiezi_head_imageview);
		...
		viewHolder.mi_comment.setText(String.valueOf(((Mibos)mMibos.get(position)).getCommentCount()));
